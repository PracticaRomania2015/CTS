/*! CTS User Tickets View */

var UserTicketsView = Backbone.View.extend({
	...
	render: function () {
		this.$el.empty();
		/* Header */
		var header = createElem('h1',{class:'userPage'},'Tickets submitted by me');
		/* Search */
		// Search input
	...
	viewData: function (pageNumber, searchText, searchType) {
		...
		if (pageNumber > Number(this.model.get('totalNumberOfPages'))) {
			pageNumber = Number(this.model.get('totalNumberOfPages'));
